...
class TemporalPositioning(AbstractTask):
    ...
    def run(self, 
        ...
        try:
            ...
            move_dict = {}
            diff = random.randint(0, MOVE_STEP - 2)
            start1 = random.randint(0, MOVE_STEP - 2 - diff)
            end1 = random.randint(start1 + 1, MOVE_STEP - 1)
            start2 = start1 + diff
            end2 = random.randint(start2 + 1, MOVE_STEP - 1)
