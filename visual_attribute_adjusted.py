...
# python visual_attribute.py --output "/data/shared/sim/benchmark/tdw/image_capture/test" --cameras top --name test2 --action circle_1 --size 0.3
if __name__ == "__main__":
    ...
    # Scene
    parser.add_argument("--scene", type=str, default="box_room_2018", help="The Scene to initialize.")
    # Object
