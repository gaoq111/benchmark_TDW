...
#             if scene in {"box_room_2018", "monkey_physics_room"}:
#                 interior_lighting.reset(hdri_skybox="old_apartments_walkway_4k", aperture=9, focus_distance=2.5, ambient_occlusion_intensity=0.07, ambient_occlusion_thickness_modifier=1.5, shadow_strength=0.5 )
#                 c.add_ons.append(interior_lighting)
#             elif scene == "box_room_2018":
#                 interior_lighting.reset(hdri_skybox="old_apartments_walkway_4k", aperture=5, focus_distance=2.5, ambient_occlusion_intensity=0.07, ambient_occlusion_thickness_modifier=3.5, shadow_strength=1)
...
#                                         {"$type": "set_render_quality", "render_quality": args.render_quality}, {"$type": "set_ambient_intensity", "intensity": 1000.0}, {"$type": "adjust_point_lights_intensity_by", "intensity": 1005}]
...
#                                     commands= [{"$type": "teleport_object", "position": {"x": x_d, "z": z_d, "y": y}, 
#                                                 "id": movable_object_id, "physics": False, "absolute": True, "use_centroid": False}]
#                                     commands.append({
#                                         "$type": "add_hdri_skybox",
#                                         "name": "old_apartments_walkway_4k",
#                                         "exposure": 0.5, 
#                                         "sun_intensity": 2,
#                                         "sun_initial_angle": 200  
#                                     })
#                                     commands.append({"$type": "set_ambient_intensity", "intensity": 2})
#                                     c.communicate(commands)
...
#         output_path = args.output_path
#         with open(os.path.join(output_path, "direction.json"), 'w') as f:
